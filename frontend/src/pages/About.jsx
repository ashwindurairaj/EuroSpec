...
const facilities = [
  {
    name: "Plant 1",
    address: "130 Harry Walker Parkway, Newmarket",
    size: "110,000 Sq. Ft.",
  },
  { name: "Plant 2", address: "Newmarket, Ontario", size: "55,000 Sq. Ft." },
  {
    name: "Warehouse",
    address: "100 Vandorf Sideroad, Aurora",
...
const directors = [
  {
    name: "PIRABA GURUMURTHI",
    role: "Human Resources",
    icon: Users,
    image: PIRABA,
    description:
      "Cultivating exceptional talent and fostering organizational excellence through strategic initiatives.",
  },
  {
    name: "INDAR MUDALIAR",
    role: "QUALITY, MAINTENANCE, MPL",
    icon: Award,
    image: INDAR,
    description:
      "Maintaining world-class quality standards and ensuring IATF 16949 compliance.",
  },
  {
    ...
    image: Nancy,
    description:
      "Ensuring financial excellence and strategic fiscal planning for sustainable growth.",
  },
  {
    name: "RANDY DUIVESTEYN",
    role: "NEW TOOLING & PRESS SHOP",
    icon: Building2,
    image: RANDY,
    description:
      "Driving operational excellence and production efficiency across all facilities.",
  },
  {
    name: "VLADIMIR POSATSKIY",
    role: "HEAD OF ENGINEERING",
    icon: Globe,
    image: VLADIMIR,
    description:
      "Building enduring partnerships with global customers and expanding market presence.",
  },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-500 mb-6">
                  ...
                  Tooling & Manufacturing, has been serving the automotive
                  industry for four decades.
                </p>
                <p className="text-gray-500 mb-8">
                  With a combined facility of over 165,000 square feet and 250
                  dedicated employees, we produce over 60 million components
                  annually.
                </p>
                <div className="grid grid-cols-2 gap-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Combined Facility</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Shipping Reach</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
        ...
        {/* Leadership Team Section - ULTRA ELEGANT & SOPHISTICATED */}
        <section className="py-32 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
          ...
          <div
            className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-accent/8 to-transparent rounded-full blur-3xl"
            style={{ animation: "float 20s ease-in-out infinite" }}
          />
          <div
            className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-tr from-primary/6 to-transparent rounded-full blur-3xl"
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            <div className="text-center mb-28">
              <div className="inline-flex items-center gap-4 mb-8">
                ...
                <div className="px-6 py-2.5 bg-white shadow-lg rounded-full border border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium tracking-[0.25em] uppercase text-primary">
                      Leadership Team
                    </span>
                  </div>
                </div>
              ...
              <h2 className="font-serif text-6xl md:text-7xl font-extralight text-primary mb-6 tracking-tight">
                Our{" "}
                <span className="font-normal italic bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
                  Visionaries
                </span>
              </h2>
              <p className="text-gray-500 text-xl max-w-2xl mx-auto leading-relaxed font-light">
                Distinguished leaders driving innovation and transformative
                excellence
              </p>
            </div>

            {/* CEO Card - Museum-Quality Design */}
                  ...
                  <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="absolute bottom-10 right-10">
                          <div className="px-6 py-3 bg-white/98 backdrop-blur-2xl rounded-2xl shadow-xl border border-white/60">
                            <div className="text-center">
                              <p className="text-2xl font-serif font-bold text-accent mb-0.5">
                                40+
                              </p>
                    ...
                    <div className="lg:w-[55%] p-12 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-white via-white to-gray-50/30">
                      ...
                      <p className="text-gray-600 text-lg leading-relaxed mb-10 font-light">
                        Pioneering strategic innovation and operational
                        excellence in automotive manufacturing. Leading with
                        unwavering vision, integrity, and commitment to
                        transformative growth.
                      </p>

                      <div className="flex flex-wrap gap-3">
                        <div className="px-6 py-2.5 bg-white hover:bg-gray-50 rounded-xl border border-gray-200 hover:border-accent/30 transition-all duration-300 shadow-sm">
                        ...
                        <div className="px-6 py-2.5 bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl border border-accent/20 shadow-sm">
            ...
            {/* Directors - Gallery Style with Large Portraits */}
              ...
              {directors.map((director, index) => {
                ...
                return (
                  <div key={index} className="group relative">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden border border-gray-100 transition-all duration-700 transform hover:-translate-y-4">
                      ...
                      <div className="aspect-[4/5] relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
                        ...
                        {/* Icon watermark - kept subtle in background */}
                        {/* <div className="absolute inset-0 flex items-center justify-center opacity-[0.08]">
                          <IconComponent className="w-40 h-40 text-primary" />
                        </div> */}
        ...
        <section className="py-24 bg-primary text-white">
          <div className="max-w-3xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-gray-200 mb-8">
              "We are committed to meeting all customer expectations through
              communication, commitment to employee development, and continual
              improvement."
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="font-semibold">
                  IATF 16949: Design & Manufacturing
                </p>
                <p className="text-sm text-gray-300">
                  Bureau Veritas Certified since 2018
                </p>
              </div>
            </div>
          </div>
